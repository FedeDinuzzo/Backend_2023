...
mongoose.connect("mongodb+srv://federicodinuzzo98:coderhouse@cluster0.rae3wln.mongodb.net/?retryWrites=true&w=majority")
.then(() => console.log("DB Connected"))
.catch(error => console.log("Error conexion MongoDB Atlas:", error))
